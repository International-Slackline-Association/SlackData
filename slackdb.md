...
`frontend/src/data/gearImages.json` is built by `scripts/build_gear_images.py` from scraped
SlackDB images. Its validation step flags **orphan keys** — manifest keys that resolve to no
